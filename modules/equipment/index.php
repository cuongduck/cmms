...
(function() {
    function initEquipment() {
        ...
        console.log('Equipment module loaded successfully');
    ...
    $('#selectAll').on('change', function() {
        ...
        function loadXuongOptions() {
            CMMS.ajax('api.php', {
                ...
                console.error('Load xuong error:', error);
            });
        }
        ...
        window.generateDetailHTML = function(data) {
            return `
                <div class="row">
                    <div class="col-md-8">
        ...
        window.showQR = function(equipmentId) {
